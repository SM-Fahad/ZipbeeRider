...
import 'package:ZipBee_Driver/features/cancelled_order/controller/cancelled_order_controller.dart';
...
class _CancelledOrderScreenState extends State<CancelledOrderScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: _buildAppBar(),
      body: Obx(() {
        if (controller.isLoading.value && controller.cancelledOrders.isEmpty) {
        ...
        if (controller.errorMessage.isNotEmpty &&
          ...
          return _ErrorState(
            ...
            onRetry: controller.fetchCancelledOrders,
          );
        }
        ...
        return LayoutBuilder(
          builder: (context, constraints) => RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemCount: controller.cancelledOrders.isEmpty
                  ? 1
                  : controller.cancelledOrders.length + 1,
              ...
              itemBuilder: (context, index) {
                ...
                if (index == controller.cancelledOrders.length) {
