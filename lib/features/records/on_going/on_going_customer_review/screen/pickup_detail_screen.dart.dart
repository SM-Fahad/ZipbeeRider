...
import 'package:ZipBee_Driver/features/records/on_going/on_going_customer_review/controller/pickup_detail_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class PickupDetailScreen extends StatelessWidget {
  final controller = Get.put(PickupDetailController());

  PickupDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    void animateBack(PickupDetailController ctrl, double maxDrag) {
