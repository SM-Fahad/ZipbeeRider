...
// import 'package:ZipBee_Driver/features/car_express_customer_complete_review/screen/car_express_customer_complete_review_screen.dart';
...
// class CarExpressCustomerPendingReviewScreen extends StatelessWidget {
//   final controller = Get.put(CarExpressCustomerPendingReviewController());

//   CarExpressCustomerPendingReviewScreen({super.key});
...
//     void animateBack(
//       CarExpressCustomerPendingReviewController ctrl,
//       double maxDrag,
//     ) {
...
//                       ),
//                       SizedBox(height: 6),
//                       Obx(() => Text(controller.remarks.value)),
//                       SizedBox(height: 18),
...
//                       Obx(
//                         () => Row(
//                           children: controller.pickupImages.map((img) {
//                             return Container(
...
//                                     Get.to(
//                                       () =>
//                                           CarExpressCustomerCompleteReviewScreen(),
//                                     );
//                                     Future.delayed(
