...
// import 'package:ZipBee_Driver/features/car_express_customer_take_photo/car_express_preview_photo/screen/car_express_preview_photo.dart';
...
// class CarExpressCustomerTakePhotoScreen extends StatelessWidget {
//   final controller = Get.put(CarExpressCustomerTakePhotoController());

//   CarExpressCustomerTakePhotoScreen({super.key});
...
//     void animateBack(
//       CarExpressCustomerTakePhotoController ctrl,
//       double maxDrag,
//     ) {
...
//                                 // Inside onHorizontalDragEnd of slider:
//                                 onHorizontalDragEnd: (details) async {
//                                   if (controller.dragX.value >= maxDrag - 5) {
//                                     await controller.openCameraFirst();

//                                     await controller.openGalleryNext();

//                                     if (controller.selectedImages.isNotEmpty) {
//                                       Get.to(() => CarExpressPreviewPhoto());
//                                     }

//                                     // Reset slider for next slide
//                                     Future.delayed(
